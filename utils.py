...
def generate_script(subject, video_lenght, creativity, api_key):
    ...
    #模型实例化 如果使用第三方的API，添加参数openai_api_base="API地址",没有则直接删除该参数
    model = ChatOpenAI(model="gpt-3.5-turbo",openai_api_key=api_key,temperature=creativity,openai_api_base="https://api.aigc369.com/v1")
    # 标题链
